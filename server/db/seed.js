...
const QUESTIONS = {
  Inbound: [
    ...
    { section: 'Truck Inspection',  question: 'Truck interior temperature (°F)',          type: 'temperature', required: 0, sort_order: 2 },
    { section: 'Truck Inspection',  question: 'Temperature gun photo',                   type: 'photo',       required: 0, sort_order: 3 },
    { section: 'Truck Inspection',  question: 'Truck clean and free of contamination?',  type: 'yes_no',      required: 1, sort_order: 4 },
    { section: 'Truck Inspection',  question: 'Load integrity — no tipping or shifted pallets?', type: 'yes_no', required: 1, sort_order: 5 },
  ...
  Outbound: [
    ...
    { section: 'Truck Inspection',  question: 'Truck interior temperature (°F)',           type: 'temperature', required: 0, sort_order: 3 },
    { section: 'Truck Inspection',  question: 'Temperature gun photo',                    type: 'photo',       required: 0, sort_order: 4 },
    { section: 'Truck Inspection',  question: 'Temperature control setpoint photo',       type: 'photo',       required: 0, sort_order: 5 },
    { section: 'Truck Inspection',  question: 'Truck clean and suitable for food?',       type: 'yes_no',      required: 1, sort_order: 6 },
